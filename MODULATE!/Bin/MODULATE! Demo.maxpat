...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.0, 358.0, 132.0, 90.0 ],
					"varname" : "extaudio",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-33",
									"items" : [ "<separator>", ",", "(Audio Sources)", ",", "<separator>", ",", "External Audio", ",", "VCO ", ",", "Noise ", ",", "Wave Table", ",", "Sampler ", ",", "Resampler ", ",", "R303 ", ",", "Ripple VCO", ",", "Modal Synth", ",", "Bass Drum", ",", "<separator>", ",", "(Effects)", ",", "<separator>", ",", "Ring Modulator", ",", "Dual S&H", ",", "Phazer ", ",", "Delay ", ",", "Stereo Delay", ",", "Echo&Shift ", ",", "Reverb ", ",", "Distort ", ",", "Waveshaper ", ",", "Moebius Tube", ",", "Grandma's Radio", ",", "<separator>", ",", "(Filters)", ",", "<separator>", ",", "Low-Pass VCF", ",", "Multi-Mode VCF", ",", "Ladder VCF", ",", "Comb VCF", ",", "VCRF ", ",", "Graphic Filter", ",", "Vocal Filter", ",", "FFT Lab", ",", "Video Filter", ",", "<separator>", ",", "(CV Stuff)", ",", "<separator>", ",", "VC LFO", ",", "VC ADSR", ",", "Quad Decay", ",", "Bouncing CV", ",", "CV Sequencer", ",", "Drum Sequencer", ",", "Graphic Step", ",", "Graphic Sequencer", ",", "Arpeggiator ", ",", "Joy Stick", ",", "Theremin ", ",", "Envelope Follower", ",", "MIDI to CV", ",", "<separator>", ",", "(Trigger Stuff)", ",", "<separator>", ",", "Trigger Source", ",", "Manual Trigger", ",", "Clock Divider", ",", "Clock Sequencer", ",", "Rhythm Sequencer", ",", "Random Trigger Gate", ",", "Trigger Delay", ",", "<separator>", ",", "(Other)", ",", "<separator>", ",", "VCA ", ",", "Dual VCA", ",", "Low-Pass Gate", ",", "CV Panner", ",", "Mixer ", ",", "Console Mixer", ",", "VST Loader", ",", "Dual Slew Limiter", ",", "Attenuator ", ",", "Math Operations", ",", "Analyzer ", ",", "Rack " ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
