...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-33",
									"items" : [ "<separator>", ",", "(Audio Sources)", ",", "<separator>", ",", "External Audio", ",", "VCO ", ",", "Noise ", ",", "Wave Table", ",", "Sampler ", ",", "Resampler ", ",", "R303 ", ",", "Ripple VCO", ",", "Modal Synth", ",", "<separator>", ",", "(Effects)", ",", "<separator>", ",", "Ring Modulator", ",", "Dual S&H", ",", "Phazer ", ",", "Delay ", ",", "Stereo Delay", ",", "Echo&Shift ", ",", "Reverb ", ",", "Distort ", ",", "Waveshaper ", ",", "Moebius Tube", ",", "Grandma's Radio", ",", "<separator>", ",", "(Filters)", ",", "<separator>", ",", "Low-Pass VCF", ",", "Multi-Mode VCF", ",", "Ladder VCF", ",", "Comb VCF", ",", "VCRF ", ",", "Graphic Filter", ",", "Vocal Filter", ",", "FFT Lab", ",", "Video Filter", ",", "<separator>", ",", "(CV Stuff)", ",", "<separator>", ",", "VC LFO", ",", "VC ADSR", ",", "Quad Decay", ",", "Bouncing CV", ",", "CV Sequencer", ",", "Graphic Step", ",", "Graphic Sequencer", ",", "Joy Stick", ",", "Theremin ", ",", "Envelope Follower", ",", "MIDI to CV", ",", "<separator>", ",", "(Trigger Stuff)", ",", "<separator>", ",", "Trigger Source", ",", "Manual Trigger", ",", "Clock Divider", ",", "Clock Sequencer", ",", "Rythm Sequencer", ",", "Random Trigger Gate", ",", "Trigger Delay", ",", "<separator>", ",", "(Other)", ",", "<separator>", ",", "VCA ", ",", "Dual VCA", ",", "Low-Pass Gate", ",", "CV Panner", ",", "Mixer ", ",", "Console Mixer", ",", "VST Loader", ",", "Dual Slew Limiter", ",", "Attenuator ", ",", "Math Operations", ",", "Analyzer ", ",", "Rack " ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-8::obj-5" : [ "live.dial[288]", "FCV", 0 ],
			...
			"obj-91::obj-2" : [ "live.toggle[106]", "live.toggle", 0 ],
			...
			"obj-58::obj-62" : [ "live.toggle[3]", "live.toggle", 0 ],
			...
			"obj-8::obj-15" : [ "live.dial[287]", "CV", 0 ],
			...
			"obj-8::obj-2" : [ "live.dial[427]", "Res.", 0 ],
			...
			"obj-1::obj-23" : [ "live.dial[314]", "Res.", 0 ],
			...
			"obj-58::obj-1" : [ "live.text[90]", "live.text", 0 ],
			...
			"obj-26::obj-20" : [ "live.tab[4]", "live.tab", 0 ],
