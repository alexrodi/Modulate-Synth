...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 861.0, 376.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Filters",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.0, 636.0, 268.0, 108.0 ],
					"varname" : "Reverb",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 540.0, 340.0, 132.0, 90.0 ],
					"varname" : "extaudio",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "" ],
					"patching_rect" : [ 270.0, 234.0, 268.0, 124.0 ],
					"varname" : "Ripplevco",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1215.0, 706.0, 268.0, 190.0 ],
					"varname" : "Gseq",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "" ],
					"patching_rect" : [ 270.0, 744.0, 268.0, 70.0 ],
					"varname" : "distort",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "" ],
					"patching_rect" : [ 1485.0, 762.0, 268.0, 110.0 ],
					"varname" : "cvseq",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 1485.0, 706.0, 268.0, 56.0 ],
					"varname" : "miditocv",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "" ],
					"patching_rect" : [ 1755.0, 68.0, 268.0, 150.0 ],
					"varname" : "FFTLab",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "signal", "" ],
					"patching_rect" : [ 1755.0, 218.0, 268.0, 92.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "" ],
					"patching_rect" : [ 270.0, 814.0, 268.0, 78.0 ],
					"varname" : "wavehsaper",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-33",
									"items" : [ "<separator>", ",", "(Audio Sources)", ",", "<separator>", ",", "External Audio", ",", "VCO ", ",", "Noise ", ",", "Wave Table", ",", "Sampler ", ",", "Resampler ", ",", "R303 ", ",", "Ripple VCO", ",", "Modal Synth", ",", "<separator>", ",", "(Effects)", ",", "<separator>", ",", "Ring Modulator", ",", "Dual S&H", ",", "Phazer ", ",", "Delay ", ",", "Stereo Delay", ",", "Echo&Shift ", ",", "Reverb ", ",", "Distort ", ",", "Waveshaper ", ",", "Moebius Tube", ",", "Grandma's Radio", ",", "<separator>", ",", "(Filters)", ",", "<separator>", ",", "Low-Pass VCF", ",", "Multi-Mode VCF", ",", "Comb VCF", ",", "VCRF ", ",", "Graphic Filter", ",", "Vocal Filter", ",", "FFT Lab", ",", "Video Filter", ",", "<separator>", ",", "(CV Stuff)", ",", "<separator>", ",", "VC LFO", ",", "VC ADSR", ",", "Quad Decay", ",", "Bouncing CV", ",", "CV Sequencer", ",", "Graphic Step", ",", "Graphic Sequencer", ",", "Joy Stick", ",", "Theremin ", ",", "Envelope Follower", ",", "MIDI to CV", ",", "<separator>", ",", "(Trigger Stuff)", ",", "<separator>", ",", "Trigger Source", ",", "Manual Trigger", ",", "Clock Divider", ",", "Clock Sequencer", ",", "Rythm Sequencer", ",", "Random Trigger Gate", ",", "Trigger Delay", ",", "<separator>", ",", "(Other)", ",", "<separator>", ",", "VCA ", ",", "Dual VCA", ",", "CV Panner", ",", "Mixer ", ",", "Console Mixer", ",", "VST Loader", ",", "Dual Slew Limiter", ",", "Attenuator ", ",", "Math Operations", ",", "Analyzer ", ",", "Rack " ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 106.0, 35.0, 29.5, 13.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 36.0, 24.0, 13.0 ],
					"style" : "",
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 1902.0, 284.0, 0.0, 0.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-91::obj-2" : [ "live.toggle[95]", "live.toggle", 0 ],
			"obj-14::obj-28" : [ "live.dial[394]", "CV", 0 ],
			"obj-76::obj-131" : [ "live.dial[305]", "PW", 0 ],
			...
			"obj-58::obj-62" : [ "live.toggle[89]", "live.toggle", 0 ],
			"obj-45::obj-117" : [ "live.text[63]", "live.text", 0 ],
			...
			"obj-26::obj-1::obj-20" : [ "live.tab", "live.tab", 0 ],
			...
			"obj-26::obj-1::obj-74" : [ "live.dial[245]", "X Offs", 0 ],
			...
			"obj-58::obj-26" : [ "live.text[10]", "live.text[9]", 0 ],
			...
			"obj-58::obj-23" : [ "live.toggle[1]", "live.toggle", 0 ],
			...
			"obj-58::obj-17" : [ "live.numbox", "live.numbox", 0 ],
			...
			"obj-26::obj-1::obj-82" : [ "live.numbox[11]", "live.numbox", 0 ],
			...
			"obj-58::obj-16" : [ "live.toggle", "live.toggle", 0 ],
			...
			"obj-58::obj-1" : [ "live.text[61]", "live.text", 0 ],
			...
			"obj-76::obj-15" : [ "live.dial[298]", "ECHO", 0 ],
			...
			"obj-42::obj-89" : [ "live.toggle[3]", "live.toggle", 0 ],
			...
			"obj-76::obj-4" : [ "live.dial[308]", "Feed CV", 0 ],
			...
			"obj-90::obj-63::obj-17" : [ "live.text[110]", "live.text", 0 ],
			...
			"obj-26::obj-1::obj-77" : [ "live.numbox[12]", "live.numbox", 0 ],
			...
			"obj-58::obj-59" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-58::obj-30" : [ "live.numbox[5]", "live.numbox", 0 ],
			...
			"obj-31::obj-63::obj-17" : [ "live.text[24]", "live.text", 0 ],
			...
			"obj-76::obj-14" : [ "live.dial[307]", "Time CV", 0 ],
			...
			"obj-45::obj-35" : [ "live.text[111]", "live.text", 0 ],
			...
			"obj-54::obj-14" : [ "live.text[11]", "live.text", 0 ],
			...
			"obj-58::obj-9" : [ "live.text[9]", "live.text[9]", 0 ],
			...
			"obj-12::obj-19" : [ "live.toggle[50]", "live.toggle", 0 ],
			...
			"obj-76::obj-2" : [ "live.dial[254]", "Dry/Wet", 0 ],
			"obj-12::obj-1" : [ "live.dial[242]", "X Offs", 0 ],
			"obj-36::obj-27" : [ "live.text[26]", "live.text[26]", 0 ],
			"obj-58::obj-2" : [ "live.numbox[3]", "live.numbox", 0 ],
			...
			"obj-87::obj-133" : [ "live.text[95]", "live.text", 0 ],
			"obj-77::obj-66" : [ "live.dial[328]", "Offset", 0 ],
			"obj-76::obj-5" : [ "live.dial[255]", "Feedback", 0 ],
			...
			"obj-50::obj-63" : [ "live.toggle[106]", "live.toggle", 0 ],
			...
			"obj-26::obj-1::obj-80" : [ "live.numbox[10]", "live.numbox", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "rack.maxpat",
				"bootpath" : "~/Documents/MODULATE! (distribute)/Bin",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
