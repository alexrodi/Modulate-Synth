...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1091.0, 4.0, 37.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.407627, 0.412426, 0.412329, 0.0 ],
					"fontsize" : 4.0,
					"hidden" : 1,
					"id" : "obj-15",
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1095.0, 12.0, 19.0, 13.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1093.0, 9.0, 15.0, 13.0 ],
					"style" : "",
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 957.25, 31.999939, 45.0, 17.0 ],
					"rounded" : 20.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 957.25, 1.999939, 123.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1094.291748, 11.0, 19.0, 13.0 ],
					"style" : "",
					"text" : "s plc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 957.25, 1.999939, 122.75, 44.000061 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 957.25, 1.999939, 48.0, 22.0 ],
					"style" : "",
					"text" : "s conn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 957.25, 1.999939, 57.0, 22.0 ],
					"style" : "",
					"text" : "zoom $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 957.25, 1.999939, 42.0, 22.0 ],
					"style" : "",
					"text" : "* 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 957.25, 1.999939, 38.0, 22.0 ],
					"style" : "",
					"text" : "t 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 35.0, 70.0, 19.0, 35.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 975.416667, 47.999939, 965.083333, 47.999939, 965.083333, 0.999939, 966.75, 0.999939 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-19::obj-98" : [ "live.dial[469]", "Gain", 0 ],
			...
			"obj-59::obj-31" : [ "live.dial[131]", "1", 0 ],
			...
			"obj-19::obj-76" : [ "live.dial[441]", "Res.", 0 ],
			...
			"obj-76::obj-5" : [ "live.dial[279]", "Feedback", 0 ],
			...
			"obj-73::obj-21" : [ "live.dial[459]", "Dec.", 0 ],
			...
			"obj-59::obj-28" : [ "live.dial[458]", "1", 0 ],
			"obj-60::obj-67" : [ "live.dial[399]", "Color", 0 ],
			"obj-64" : [ "live.slider[5]", "Zoom", 0 ],
			...
			"obj-59::obj-56" : [ "live.text[132]", "live.text", 0 ],
			"obj-59::obj-30" : [ "live.dial[473]", "1", 0 ],
			"obj-51::obj-2" : [ "live.dial[38]", "Range", 0 ],
			"obj-51::obj-1" : [ "live.dial[359]", "Tune", 0 ],
			...
			"obj-59::obj-32" : [ "live.dial[472]", "1", 0 ],
			"obj-38::obj-13" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-75::obj-17" : [ "live.text[118]", "live.text", 0 ],
			...
			"obj-75::obj-10" : [ "live.text[137]", "live.text", 0 ],
			...
			"obj-59::obj-91" : [ "live.text[110]", "live.text", 0 ],
			"obj-61::obj-23" : [ "live.dial[474]", "Freq", 0 ],
			...
			"obj-73::obj-51" : [ "live.dial[460]", "Dec.", 0 ],
			...
			"obj-19::obj-81" : [ "live.dial[453]", "Res.", 0 ],
			"obj-55" : [ "live.dial[70]", "Pan", 0 ],
			...
			"obj-38::obj-1" : [ "live.menu", "live.menu", 0 ],
			...
			"obj-76::obj-166" : [ "live.dial[54]", "Depth", 0 ],
			"obj-90::obj-83" : [ "live.dial[414]", "CV", 0 ],
			"obj-19::obj-90" : [ "live.dial[449]", "Res.", 0 ],
			"obj-60::obj-70" : [ "live.dial[254]", "2", 0 ],
			...
			"obj-73::obj-9" : [ "live.dial[454]", "Dec.", 0 ],
			"obj-38::obj-9" : [ "live.menu[1]", "live.menu", 0 ],
			...
			"obj-59::obj-36" : [ "live.dial[471]", "1", 0 ],
			...
			"obj-59::obj-101" : [ "live.text[133]", "live.text", 0 ],
			"obj-59::obj-35" : [ "live.dial[470]", "1", 0 ],
			...
			"obj-76::obj-15" : [ "live.dial[280]", "ECHO", 0 ],
			...
			"obj-59::obj-33" : [ "live.dial[442]", "1", 0 ],
			"obj-60::obj-64" : [ "live.dial[445]", "Gain", 0 ],
			...
			"obj-38::obj-25" : [ "live.menu[5]", "live.menu", 0 ],
			"obj-38::obj-21" : [ "live.menu[4]", "live.menu", 0 ],
			...
			"obj-73::obj-43" : [ "live.dial[476]", "Dec.", 0 ],
			"obj-75::obj-12" : [ "live.text[119]", "live.text", 0 ],
			...
			"obj-60::obj-63" : [ "live.dial[145]", "Gain", 0 ],
			...
			"obj-76::obj-2" : [ "live.dial[53]", "Dry/Wet", 0 ],
			...
			"obj-59::obj-34" : [ "live.dial[457]", "1", 0 ],
			...
			"obj-38::obj-40::obj-26" : [ "live.button", "live.button", 0 ],
