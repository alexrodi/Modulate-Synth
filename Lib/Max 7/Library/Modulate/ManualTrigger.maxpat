...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.5, 613.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 108.5, 227.5, 55.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 48.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 160.5, 403.0, 44.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 5.5, 365.0, 92.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 140.5, 481.0, 24.0, 22.0 ],
					"style" : "",
					"text" : "t 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 130.916687, 86.5, 24.0, 22.0 ],
									"style" : "",
									"text" : "t 1"
								}
...
,
					"patching_rect" : [ 108.5, 258.0, 31.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 792.0, 121.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 38.5, 67.5, 24.0, 19.0 ],
					"rounded" : 10.0,
					"varname" : "out_1"
				}
...
,
					"patching_rect" : [ 612.0, 67.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 671.0, 129.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "s to_move"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 612.0, 99.0, 26.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.6875, 0.5, 100.0, 82.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 77.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "r hpline"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 792.0, 91.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "r delfb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 716.5, 67.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "regexp _ \" \""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 716.5, 39.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"mode" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 736.0, 171.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "s conn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 671.0, 99.0, 84.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "click",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 590.333313, 16.0, 84.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -2.3125, -1.5, 104.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 125.5, 348.5, 34.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.5, 377.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 108.5, 315.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 49.5, 568.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.5, 519.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 49.5, 481.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.5, 519.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 140.5, 455.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "delay",
					"varname" : "delay[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.5, 396.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 100.5, 568.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 49.0, 20.0, 20.0 ],
					"varname" : "pictctrl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 136.5, 519.0, 58.0, 22.0 ],
					"restore" : 					{
						"live.dial[5]" : [ 645.854271 ],
						"live.tab" : [ 1.0 ],
						"live.toggle[1]" : [ 0.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 665.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.5, 665.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -1.5, 665.0, 30.0, 30.0 ],
					"style" : ""
				}
