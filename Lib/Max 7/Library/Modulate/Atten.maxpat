...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.0, 385.0, 61.0, 22.0 ],
					"presentation_rect" : [ 156.5, 386.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.5, 385.0, 61.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "sigmsg",
						"parameter_enable" : 0
					}
...
,
					"patching_rect" : [ 768.0, 166.646271, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 768.0, 200.646271, 26.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.6875, 0.5, 266.896301, 60.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 850.0, 130.646271, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"mode" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 107.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "r hpline"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 980.0, 222.646271, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 179.524353, 45.5, 27.475647, 19.0 ],
					"rounded" : 10.0,
					"varname" : "out_3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 959.0, 153.646271, 44.0, 22.0 ],
					"style" : "",
					"text" : "r delfb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 980.0, 200.646271, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 187.21933, -2.0, 19.78067, 18.5 ],
					"rounded" : 10.0,
					"varname" : "in_3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 959.0, 200.646271, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 61.5, -2.0, 18.333332, 18.5 ],
					"rounded" : 10.0,
					"varname" : "in_1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 959.0, 222.646271, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.75, 45.5, 27.5, 19.0 ],
					"rounded" : 10.0,
					"varname" : "out_1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 850.0, 166.646271, 72.0, 22.0 ],
					"style" : "",
					"text" : "regexp _ \" \""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 903.0, 272.646271, 46.0, 22.0 ],
					"style" : "",
					"text" : "s conn"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 838.0, 230.646271, 66.0, 22.0 ],
					"style" : "",
					"text" : "s to_move"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 838.0, 200.646271, 84.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "click",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 746.333313, 112.646278, 84.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.25, 427.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.5, 427.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.5, 427.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 427.0, 30.0, 30.0 ],
					"style" : ""
				}
