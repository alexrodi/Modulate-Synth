...
,
					"patching_rect" : [ 242.700012, 505.0, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 115.0, 232.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "gate~ 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 157.0, 260.0, 82.0, 22.0 ],
									"style" : "",
									"text" : "clip~ 0 20000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.0, 109.0, 47.0, 22.0 ],
									"style" : "",
									"text" : "$1 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 157.0, 137.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 227.0, 80.0, 47.0, 22.0 ],
									"style" : "",
									"text" : "$1 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 135.0, 295.25, 41.0, 22.0 ],
									"style" : "",
									"text" : "gate~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 113.0, 177.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "mtof~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 113.0, 145.0, 38.0, 22.0 ],
									"style" : "",
									"text" : "+~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 157.0, 177.0, 36.0, 22.0 ],
									"style" : "",
									"text" : "*~ 0."
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.700012, 468.5, 47.0, 22.0 ],
					"style" : "",
					"text" : "ftom 0."
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.200012, 495.875, 284.200012, 495.875 ],
					"source" : [ "obj-41", 0 ]
				}
