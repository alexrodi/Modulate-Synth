				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_shortname" : "live.menu",
							"parameter_type" : 2,
							"parameter_enum" : [ "Scan", "Flip", "PW", "Mirror", "Ripple 2", "Ripple 4", "Ripple ?", "Spread", "Formant", "Digitize", "Asym +", "Asym -", "Asym +/-", "Bend +", "Bend -", "Bend +/-", "Rotate +", "Rotate -", "Rotate +/-" ],
							"parameter_invisible" : 2
						}
