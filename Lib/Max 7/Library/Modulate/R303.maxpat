...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 66.0, 162.0, 62.0, 22.0 ],
									"style" : "",
									"text" : "gen~ fcv"
								}
...
,
									"patching_rect" : [ 90.5, 286.0, 57.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 139.0, 187.0, 51.0, 22.0 ],
									"style" : "",
									"text" : "gate~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 171.0, 217.0, 144.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 431.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 382.0, 83.0, 22.0 ],
									"style" : "",
									"text" : "selector~ 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 316.0, 116.0, 22.0 ],
									"style" : "",
									"text" : "selector~ 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 66.0, 111.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "*~ 60"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 346.0, 36.0, 22.0 ],
									"style" : "",
									"text" : "*~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 139.0, 248.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "saw~"
								}
