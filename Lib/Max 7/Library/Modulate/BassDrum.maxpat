...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.0, 516.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 516.0, 61.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "sigmsg",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 104.75, 417.63504, 34.0, 27.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 880.0, 287.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 880.0, 321.0, 26.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.6875, 0.5, 266.896301, 90.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 962.0, 251.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"mode" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.0, 294.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "r hpline"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1092.0, 343.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 213.524353, 71.5, 51.300648, 19.0 ],
					"rounded" : 10.0,
					"varname" : "out_3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1155.0, 321.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 209.625, -1.5, 16.115921, 33.5 ],
					"rounded" : 10.0,
					"varname" : "in_5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1176.0, 321.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 251.125, -1.5, 16.458801, 19.0 ],
					"rounded" : 10.0,
					"varname" : "in_6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1071.0, 274.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "r delfb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1113.0, 321.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 119.375397, -2.0, 29.23085, 18.5 ],
					"rounded" : 10.0,
					"varname" : "in_3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1092.0, 321.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 84.219322, -2.0, 17.999996, 18.5 ],
					"rounded" : 10.0,
					"varname" : "in_2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1134.0, 321.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 168.78653, -2.0, 16.83847, 18.5 ],
					"rounded" : 10.0,
					"varname" : "in_4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1071.0, 321.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.587502, -2.0, 17.333332, 18.5 ],
					"rounded" : 10.0,
					"varname" : "in_1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 1071.0, 343.0, 19.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 157.5, 71.5, 39.550003, 19.0 ],
					"rounded" : 10.0,
					"varname" : "out_2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 962.0, 287.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "regexp _ \" \""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1015.0, 393.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "s conn"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 950.0, 351.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "s to_move"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 950.0, 321.0, 84.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "click",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 858.333313, 233.0, 84.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.5, 294.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "border 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.0, 294.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "268 92"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.5, 258.5, 56.0, 22.0 ],
					"style" : "",
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 760.5, 233.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 760.5, 330.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.0, 330.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "size",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 603.0, 294.0, 21.0, 146.553192 ],
					"pic" : "",
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.75, 395.63504, 48.0, 20.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 66.0, 167.0, 62.0, 22.0 ],
									"style" : "",
									"text" : "gen~ fcv"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 64.5, 209.0, 148.894577, 22.0 ],
									"style" : "",
									"text" : "+~"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.277771, 546.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.0, 547.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 547.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 547.0, 30.0, 30.0 ],
					"style" : ""
				}
